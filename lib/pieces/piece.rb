...
class Piece
    ...
    def create_moves(grid, rank_change, file_change) #This take 1 of items from the move_set arr and continues applying it until it is no longer between 0..7 OR has a piece
